...
public class PlatformPreferences {
    ...
    private static PlatformPreferences prefsUtil;
    public Context context;
    public SharedPreferences prefs;
    public SharedPreferences.Editor editor;

    public synchronized static PlatformPreferences getInstance() {
        return prefsUtil;
    }

    public static void init(Context context, String prefsname, int mode) {
        prefsUtil = new PlatformPreferences();
    ...
    public PlatformPreferences putString(String key, String value) {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public PlatformPreferences putStringSet(String key, Set<String> value) {
    ...
    public PlatformPreferences remove(String key) {
        editor.remove(key);
        editor.commit();
        return this;
    }

    public PlatformPreferences removeAll() {
        editor.clear();
        editor.commit();
        return this;
    }
